...
enum ZegoLiveStreamingMenuBarButtonName {
  ...
  /// Button for PIP the current [ZegoUIKitPrebuiltLiveStreaming] widget outside the app.
  /// When clicked, the [ZegoUIKitPrebuiltLiveStreaming] widget will shrink into a small draggable widget on mobile desktop.
  ///
