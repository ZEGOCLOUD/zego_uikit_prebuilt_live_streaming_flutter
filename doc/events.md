...
- `pk`: [ZegoLiveStreamingPKEvents](#zegolivestreamingpkevents)
  - events about pk.
...
- `beauty`: [ZegoLiveStreamingBeautyEvents](#zegolivestreamingbeautyevents)
  - events about beauty.
- `hall`: [ZegoLiveStreamingHallEvents](#zegolivestreaminghallevents)
  - events about hall.
...
- **Description**
  - Callback for page push replace.
